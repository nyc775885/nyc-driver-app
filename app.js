...
console.log("%cNYC Driver Tracker — version v58","color:#00D4FF;font-weight:bold;font-size:14px");
...
if(p.type==="date"||p.type==="month"){
  var todayHandler=function(){
    var d=new Date();
    if(p.type==="month")p.onChange(d.getFullYear()+"-"+(d.getMonth()+1<10?"0":"")+(d.getMonth()+1));
    else p.onChange(d.getFullYear()+"-"+(d.getMonth()+1<10?"0":"")+(d.getMonth()+1)+"-"+(d.getDate()<10?"0":"")+d.getDate());
  };
  el=React.createElement('div',{style:{display:"flex",gap:6}},
    React.createElement('div',{style:{flex:1}},inputEl),
    React.createElement('button',{onClick:todayHandler,type:"button",style:{background:"#1A2A44",border:"1px solid #2A4A6A",color:"#00D4FF",fontSize:13,fontWeight:600,padding:"0 14px",borderRadius:8,cursor:"pointer",whiteSpace:"nowrap"}}, (typeof document!=="undefined"&&document.documentElement.lang==="en")?"Today":"今天")
  );
...
function App() {
  ...
  },[wl,sl,el,fl,ll,veh,cc,custGroups,reminders,custPlat,notes,incGoal,seRate,fedRate,stateRate,stdDed]);
  ...
  function smartSync(){
    ...
    getDriveData(accessToken,function(fileId,folderId,driveModTime){
      if(!fileId){
        ...
        if(localModTime){
          var data={wl:wl,sl:sl,el:el,fl:fl,ll:ll,veh:veh,cc:cc,custGroups:custGroups,reminders:reminders,custPlat:custPlat,notes:notes,incGoal:incGoal,seRate:seRate,fedRate:fedRate,stateRate:stateRate,stdDed:stdDed,localModTime:localModTime};
      ...
      .then(function(cloudData){
        ...
        if(cloudModTime > localModTime){
          ...
          if(cloudData.custPlat)setCustPlat(cloudData.custPlat);
          if(cloudData.notes)setNotes(cloudData.notes);
          if(cloudData.incGoal)setIncGoal(cloudData.incGoal);
  ...
  return (
      ...
      , React.createElement('div', { style: {background:C.bg,padding:"10px 14px 8px",borderBottom:"1px solid "+C.border,position:"sticky",top:0,zIndex:50}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 242}}
        , React.createElement('div', { style: {display:"flex",alignItems:"center",gap:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 243}}
          ...
          , React.createElement('div', { style: {flex:1,textAlign:"center"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 245}}
            , veh.brand||veh.plate ? React.createElement('div', { style: {fontSize:13,fontWeight:800,color:C.text}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 246}}, veh.brand?veh.brand+" ":"", veh.plate?"["+veh.plate+"]":"") : React.createElement('div', { style: {fontSize:13,fontWeight:700,color:C.text3}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 246}}, "NYC RIDESHARE TRACKER"  )
            ...
            , dashV==="month" ? (
              React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 265}}
                ...
                , React.createElement(Card, { style: {marginBottom:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 269}}
                  ...
                  , (function(){var nc=net>=0?"#00E676":"#FF5252";return React.createElement('div', { style: {fontSize:24,fontWeight:900,color:nc,letterSpacing:-1}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 271}}, fmt(net));}())
                ...
                , (function(){var isEv=veh.type==="electric";var fuelCat=isEv?"charging":"fuel";var unitName=isEv?"kWh":"Gal";var effLabel=isEv?"mi/kWh":"MPG";
                  ...
                  var calc=function(segs){
                    ...
                    return {mi:mi,un:un,co:co,eff:un>0?Math.round(mi/un*100)/100:0,cpm:mi>0?Math.round(co/mi*100)/100:0};
                  };
                  ...
                  return React.createElement(Card, { style: {marginBottom:8,padding:"12px 14px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 282}}
                    ...
                    , yStats?React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 282}}
                      ...
                      , React.createElement('div', { style: {display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 282}}
                        ...
                        , React.createElement('div', { style: {textAlign:"center"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 282}}, React.createElement('div', { style: {fontSize:14,fontWeight:700,color:"#FFD700"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 282}}, yStats.eff, " ", effLabel))
                        , React.createElement('div', { style: {textAlign:"center"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 282}}, React.createElement('div', { style: {fontSize:14,fontWeight:700,color:"#FF9A65"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 282}}, "$", yStats.cpm, "/mi"))
                      )
                    ):null
                  );
                }())
                , (function(){var isEv=veh.type==="electric";var fuelCat=isEv?"charging":"fuel";var fi=el.filter(function(e){return e.category===fuelCat&&e.qty&&+e.qty>0&&e.date&&e.date.slice(0,7)===mo;}).sort(function(a,b){return a.date.localeCompare(b.date);});if(fi.length<2)return null;var pr=fi.map(function(e){return Math.round(+e.amount/+e.qty*100)/100;});var minP=Math.min.apply(null,pr),maxP=Math.max.apply(null,pr);var unit=isEv?"/kWh":"/Gal";return React.createElement(Card, { style: {marginBottom:8,padding:"12px 14px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 281}}, React.createElement('div', { style: {fontSize:13,fontWeight:700,color:"#FFD700",marginBottom:8}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 281}}, "⛽ " , lang==="en"?(isEv?"Charging Cost Trend":"Gas Price Trend"):(isEv?"充电价格趋势":"油价趋势")), React.createElement('div', { style: {display:"flex",alignItems:"center",gap:4,height:50,marginBottom:4}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 281}}, pr.map(function(p,i){var h=maxP===minP?30:Math.round(10+(p-minP)/(maxP-minP)*35);return React.createElement('div', { key: i, style: {flex:1,display:"flex",flexDirection:"column",alignItems:"center",gap:1}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 281}}, React.createElement('div', { style: {fontSize:8,color:i===pr.length-1?"#FFD700":"#7A9AB8"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 281}}, p), React.createElement('div', { style: {width:"100%",height:h,borderRadius:"3px 3px 0 0",background:i===pr.length-1?"#FFD700":"#2A3A54"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 281}} ));}), " " ), React.createElement('div', { style: {display:"flex",justifyContent:"space-between",fontSize:11,color:C.text3}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 281}}, React.createElement('span', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 281}}, lang==="en"?"Low $":"低 $", minP, unit), React.createElement('span', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 281}}, lang==="en"?"High $":"高 $", maxP, unit), React.createElement('span', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 281}}, lang==="en"?"Latest $":"最新 $", pr[pr.length-1], unit)));}())
                ...
                , tExp > 0 ? (
                  React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 286}}
                    ...
                    , mExpDet ? React.createElement(Card, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 291}}, React.createElement(CatDetail, { items: feAll, total: tExp, allC: allC, __self: this, __source: {fileName: _jsxFileName, lineNumber: 291}} )) : React.createElement(CatBreakdown, { items: feAll, total: tExp, allC: allC, __self: this, __source: {fileName: _jsxFileName, lineNumber: 291}} )
          ...
          React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 342}}
            ...
            , expV==="month" ? (
              React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 345}}
                ...
                , React.createElement(BucketList, { items: feAll, allC: allC, lang: lang, el: el, setEl: setEl, allEl: el, emptyText: T.noData, onEditFixed: function(item){setEditFx({id:item.id,amount:item.amount,notes:item.notes||"",fixedLabel:item.fixedLabel});}, onEditExp: function(item){setEf(Object.assign({},item,{qty:item.qty||"",isRecurring:false}));setSf("exp_edit_"+item.id);}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 349}} )
              )
            ) : null
            , expV==="year" ? (
              React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 353}}
                ...
                , (function(){var allYE=yAllExps();if(!allYE.length)return React.createElement(Empty, { text: T.noData, __self: this, __source: {fileName: _jsxFileName, lineNumber: 356}} );return React.createElement(BucketList, { items: allYE, allC: allC, lang: lang, el: el, setEl: setEl, allEl: el, emptyText: "", onEditFixed: function(item){setEditFx({id:item.id,amount:item.amount,notes:item.notes||"",fixedLabel:item.fixedLabel});}, onEditExp: function(item){setEf(Object.assign({},item,{qty:item.qty||"",isRecurring:false}));setSf("exp_edit_"+item.id);}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 356}} );}())
        ...
        React.createElement('div', { style: {position:"fixed",inset:0,background:C.bg,zIndex:300,overflowY:"auto"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 389}}
          , React.createElement('div', { style: {maxWidth:600,margin:"0 auto",padding:"0 0 80px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 390}}
            , React.createElement('div', { style: {background:C.bg2,padding:"16px 18px",borderBottom:"1px solid "+C.border,display:"flex",justifyContent:"space-between",alignItems:"center",position:"sticky",top:0,zIndex:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 391}}
              ...
              , React.createElement('button', { onClick: function(){setSf(null);}, style: {background:"#1E3050",border:"none",color:"#8ABCD0",fontSize:16,cursor:"pointer",width:32,height:32,borderRadius:8,display:"flex",alignItems:"center",justifyContent:"center"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 393}}, "✕")
            )
            , React.createElement('div', { style: {padding:"16px 14px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 395}}
              ...
              , React.createElement('div', { style: {display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:8}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 397}}
                ...
                , React.createElement(Field, { label: T.brand, value: veh.brand||"", onChange: function(v){setVeh(Object.assign({},veh,{brand:v}));}, options: [["",T.selectBrand]].concat(CARBRANDS.slice(0,-1).map(function(b){return [b,b];}).concat([[lang==="en"?"Other":"其他",lang==="en"?"Other":"其他"]])), __self: this, __source: {fileName: _jsxFileName, lineNumber: 401}} )
              )
              , React.createElement('div', { style: {fontSize:13,fontWeight:700,color:"#90EAF8",marginBottom:10,marginTop:14}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 403}}, lang==="en"?"Inspection (every 4 months)":"车辆检验（每4个月）")
              ...
              , React.createElement('div', { style: {display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 414}}
                , React.createElement(Field, { label: T.loanType, value: veh.loanType||"loan", onChange: function(v){setVeh(Object.assign({},veh,{loanType:v}));}, options: [["loan",T.loan],["lease",T.lease],["own",T.own],["rental",T.rental]], __self: this, __source: {fileName: _jsxFileName, lineNumber: 415}} )
      ...
      , sf && (sf==="exp" || sf.startsWith("exp_edit_")) ? (
        React.createElement(Modal, { title: sf.startsWith("exp_edit_")?(T.edit+" "+(lang==="en"?"Expense":"支出")):(lang==="en"?"Add Expense":"添加支出"), onClose: function(){setSf(null);}, onSave: function(){if(!ef.amount)return;if(sf.startsWith("exp_edit_")){var eid=+sf.replace("exp_edit_","");setEl(el.map(function(x){return x.id===eid?Object.assign({},ef,{id:eid}):x;}));}else if(ef.isRecurring){setFl(fl.concat([{id:Date.now(),label:allC[ef.category]?allC[ef.category].label:ef.notes||"Fixed",icon:allC[ef.category]?allC[ef.category].icon:"💼",cat:ef.category,cycle:"monthly",amount:ef.amount,day:new Date().getDate()+"",notes:ef.notes,active:true,startDate:"",endDate:"",maxCount:""}]));}else{var nel=[Object.assign({},ef,{id:Date.now()})].concat(el);setEl(nel);autoSave({el:nel});}setSf(null);}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 520}}
          ...
          , (ef.category==="fuel"||ef.category==="charging") ? React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 541}}, React.createElement(Field, { label: ef.category==="charging"?(lang==="en"?"kWh Charged":"充电度数 (kWh)"):(lang==="en"?"Gallons (Gal)":"加油加仑 (Gal)"), type: "number", value: ef.qty, onChange: function(v){setEf(Object.assign({},ef,{qty:v}));}, placeholder: "0.0", __self: this, __source: {fileName: _jsxFileName, lineNumber: 541}} ), ef.amount&&ef.qty&&+ef.qty>0?React.createElement('div', { style: {background:C.bg3,border:"1px solid "+C.border,borderRadius:10,padding:"10px 14px",display:"flex",justifyContent:"space-between"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 541}}, React.createElement('span', { style: {fontSize:14,color:C.text2}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 541}}, lang==="en"?"Per Gallon":"每加仑"), React.createElement('span', { style: {fontSize:17,fontWeight:800,color:"#FFD700"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 541}}, fmt(+ef.amount/+ef.qty), "/Gal")):null) : null
          , (ef.category==="charging") ? React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 542}}, React.createElement(Field, { label: lang==="en"?"Energy (kWh)":"充电度数 (kWh)", type: "number", value: ef.qty, onChange: function(v){setEf(Object.assign({},ef,{qty:v}));}, placeholder: "0", __self: this, __source: {fileName: _jsxFileName, lineNumber: 542}} ), ef.amount&&ef.qty&&+ef.qty>0?React.createElement('div', { style: {background:C.bg3,border:"1px solid "+C.border,borderRadius:10,padding:"10px 14px",display:"flex",justifyContent:"space-between"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 542}}, React.createElement('span', { style: {fontSize:14,color:C.text2}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 542}}, lang==="en"?"Per kWh":"每度电"), React.createElement('span', { style: {fontSize:17,fontWeight:800,color:"#FFD700"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 542}}, fmt(+ef.amount/+ef.qty), "/kWh")):null) : null
          ...
          , React.createElement(Field, { label: T.notes, value: ef.notes, onChange: function(v){setEf(Object.assign({},ef,{notes:v}));}, placeholder: T.optional, __self: this, __source: {fileName: _jsxFileName, lineNumber: 543}} )
      ...
      , sf && (sf==="lic" || sf.startsWith("lic_edit_")) ? (
        React.createElement(Modal, { title: sf.startsWith("lic_edit_")?(T.edit+" "+(lang==="en"?"License":"执照")):(lang==="en"?"Add License":"添加执照/证件"), onClose: function(){setSf(null);}, onSave: function(){if(!lf.type)return;if(sf.startsWith("lic_edit_")){var lid=+sf.replace("lic_edit_","");setLl(ll.map(function(x){return x.id===lid?Object.assign({},lf,{id:lid}):x;}));}else{setLl([Object.assign({},lf,{id:Date.now()})].concat(ll));}setSf(null);}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 567}}
          , React.createElement(Field, { label: T.licType, value: lf.type, onChange: function(v){setLf(Object.assign({},lf,{type:v}));}, options: [["",T.pleaseSelect]].concat((lang==="en"?LICTYPES_EN:LICTYPES_ZH).map(function(l){return [l,l];})), __self: this, __source: {fileName: _jsxFileName, lineNumber: 568}} )
        ...
        React.createElement('div', { style: {position:"fixed",inset:0,background:"rgba(0,0,0,0.92)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:300,paddingBottom:"80px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 784}}
          , React.createElement('div', { style: {background:C.bg2,borderRadius:16,width:"100%",maxWidth:600,border:"1px solid "+C.border,maxHeight:"calc(90vh - 80px)",display:"flex",flexDirection:"column",overflow:"hidden"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 785}}
            ...
            , React.createElement('div', { style: {background:C.bg3,border:"1px solid "+C.border,borderRadius:12,padding:14,marginBottom:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 808}}
              , React.createElement('div', { style: {fontSize:15,fontWeight:700,color:C.text2,marginBottom:4}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 808}}, lang==="en"?"➕ Merge Import":"➕ 合并导入")
              , React.createElement('div', { style: {fontSize:12,color:C.text3,marginBottom:8}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 808}}, lang==="en"?"Append data from a JSON file (won't delete existing)":"将 JSON 文件中的数据追加进来（不删除已有数据）")
              , React.createElement('input', { type: "file", accept: ".json", onChange: function(e){var file=e.target.files[0];if(!file)return;var inputEl=e.target;var reader=new FileReader();reader.onload=function(ev){var fileText=ev.target.result;requireDangerConfirm("mergeImport", lang==="en"?"Merge Import":"合并导入", lang==="en"?"This will append entries from this file to your current data. Existing entries are kept, but duplicates won't be detected.":"此操作会将文件中的条目追加到当前数据中。已有数据会保留，但不会自动去重。", function(){try{var data=JSON.parse(fileText);var added={el:0,sl:0,wl:0,fl:0,ll:0,reminders:0,notes:0};if(data.el&&data.el.length){setEl(el.concat(data.el));added.el=data.el.length;}if(data.sl&&data.sl.length){setSl(sl.concat(data.sl));added.sl=data.sl.length;}if(data.wl&&data.wl.length){setWl(wl.concat(data.wl));added.wl=data.wl.length;}if(data.fl&&data.fl.length){setFl(fl.concat(data.fl));added.fl=data.fl.length;}if(data.ll&&data.ll.length){setLl(ll.concat(data.ll));added.ll=data.ll.length;}if(data.reminders&&data.reminders.length){setReminders(reminders.concat(data.reminders));added.reminders=data.reminders.length;}if(data.notes&&data.notes.length){setNotes(notes.concat(data.notes));added.notes=data.notes.length;}var msg=lang==="en"?"Merged: "+added.el+" expenses, "+added.sl+" statements, "+added.wl+" weeks":"已合并："+added.el+" 笔支出, "+added.sl+" 月账单, "+added.wl+" 周记录";alert(msg);}catch(err){alert(lang==="en"?"Invalid file":"文件格式错误");}inputEl.value="";});};reader.readAsText(file);}, style: {width:"100%",background:C.bg3,border:"1px solid #2A3A54",borderRadius:8,padding:"8px",color:C.text,fontSize:13,cursor:"pointer"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 808}} )
            )
              ...
              , reportData.type==="exp" ? (
                React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 849}}
                  ...
                  , ["车辆","牌照","平台","其他"].map(function(g){var cats=reportData.byGroup[g];if(!cats||!cats.length)return null;var gTotal=cats.reduce(function(s,c){return s+c.total;},0);var gcl=g==="车辆"?"#00D4FF":g==="牌照"?"#FFD700":g==="平台"?"#CC88FF":"#B0D4E8";var glbl=lang==="en"?(g==="车辆"?"Vehicle":g==="牌照"?"License":g==="平台"?"Platform":"Other"):g;return React.createElement('div', { key: g, style: {marginBottom:16}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 851}}
                    ...
                    , cats.map(function(cat){return React.createElement('div', { key: cat.label, style: {display:"flex",justifyContent:"space-between",padding:"3px 0 3px 16px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 853}}, React.createElement('span', { style: {fontSize:13,color:C.text2}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 853}}, cat.icon, " " , cat.label), React.createElement('span', { style: {fontSize:13,color:C.text}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 853}}, fmt(cat.total)));})
