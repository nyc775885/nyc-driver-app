...
console.log("%cNYC Driver Tracker — version v145","color:#00D4FF;font-weight:bold;font-size:14px");
...
var C={bg:"#080C18",bg2:"#0D1828",bg3:"#0F1829",border:"#243550",text:"#F0F4FF",text2:"#C8E4F8",text3:"#90B4D0"};
      ...
      , React.createElement('div', { style: {padding:"16px 14px",paddingBottom:100,maxWidth:800,margin:"0 auto"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 259}}
        ...
        , tab===1 ? (
          ...
          React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 319}}
            ...
            , React.createElement('button', { onClick: function(){setPasteUberText("");setPasteUberResult(null);setShowPasteUber(true);}, style: {width:"100%",background:"#0A1828",border:"1px solid #2A4A6A",borderRadius:10,padding:"10px 14px",color:"#5AACFF",fontSize:13,fontWeight:700,cursor:"pointer",marginBottom:10,display:"flex",justifyContent:"space-between",alignItems:"center"} }
        ...
        React.createElement('div', { style: {position:"fixed",inset:0,zIndex:400,display:"flex"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 596}}
          , React.createElement('div', { style: {width:"60%",maxWidth:220,background:C.bg2,height:"100%",overflowY:"auto",borderRight:"1px solid "+C.border,display:"flex",flexDirection:"column",paddingBottom:"70px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 597}}
            , React.createElement('div', { style: {padding:"20px 18px 16px",borderBottom:"1px solid "+C.border}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 598}}
              ...
              , React.createElement('div', { style: {fontSize:11,color:C.text3,marginTop:2}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 600}}, "NYC RIDESHARE TRACKER · v2.0.3"    )
            )
