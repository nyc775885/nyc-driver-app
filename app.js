      ...
      , React.createElement('div', { style: {background:C.bg,padding:"6px 12px 5px",borderBottom:"1px solid "+C.border,position:"sticky",top:0,zIndex:50}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 242}}
        , React.createElement('div', { style: {display:"flex",alignItems:"center",gap:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 243}}
          ...
          , React.createElement('div', { style: {flex:1,textAlign:"center"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 245}}
            ...
            , React.createElement('div', { style: {fontSize:9,color:C.text3,letterSpacing:0.4}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 247}}, "NYC DRIVER TRACKER"  )
          )
          , React.createElement('button', { onClick: function(){setLang(lang==="zh"?"en":"zh");}, style: {background:"#1A2A44",border:"none",borderRadius:5,color:"#A8D0E8",fontSize:10,cursor:"pointer",padding:"2px 6px",fontWeight:700,flexShrink:0}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 249}}, lang==="zh"?"EN":"中")
        ...
        , tab===1 ? (
          ...
          React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 319}}
            ...
            , React.createElement('div', { style: {display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:16}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 321}}
              ...
              , React.createElement('button', { onClick: function(){setSf("week");}, style: {background:C.bg3,border:"1px solid "+C.border,borderRadius:10,padding:"10px 8px",cursor:"pointer",textAlign:"center"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 327}}
