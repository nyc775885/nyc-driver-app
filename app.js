...
console.log("%cNYC Driver Tracker — version v86","color:#00D4FF;font-weight:bold;font-size:14px");
        ...
        React.createElement('div', { style: {position:"fixed",inset:0,zIndex:400,display:"flex"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 596}}
          , React.createElement('div', { style: {width:"60%",maxWidth:220,background:C.bg2,height:"100%",overflowY:"auto",borderRight:"1px solid "+C.border,display:"flex",flexDirection:"column",paddingBottom:"70px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 597}}
            , React.createElement('div', { style: {padding:"20px 18px 16px",borderBottom:"1px solid "+C.border}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 598}}
              ...
              , React.createElement('div', { style: {fontSize:11,color:C.text3,marginTop:2}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 600}}, "NYC RIDESHARE TRACKER · v1.3.6"    )
            )
          ...
          , React.createElement('div', { style: {background:C.bg2,borderRadius:16,width:"100%",maxWidth:600,border:"1px solid "+C.border,maxHeight:"calc(90vh - 80px)",display:"flex",flexDirection:"column",overflow:"hidden"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 785}}
            ...
            , React.createElement('div', { style: {background:C.bg3,border:"1px solid "+C.border,borderRadius:12,padding:14,marginBottom:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 808}}
              ...
              , React.createElement('input', { type: "file", accept: ".json", onChange: function(e){var file=e.target.files[0];if(!file)return;var inputEl=e.target;var reader=new FileReader();reader.onload=function(ev){var fileText=ev.target.result;requireDangerConfirm("mergeImport", lang==="en"?"Smart Import":"智能导入", lang==="en"?"This will add new entries and update existing ones (matched by month/date+category+amount). Duplicates are skipped automatically.":"将添加新数据并更新已有数据（按月份/日期+类别+金额匹配）。重复数据会自动跳过。", function(){try{
                ...
                alert(msg);
              }catch(err){alert((lang==="en"?"Error: ":"错误：")+err.message);}inputEl.value="";});};reader.readAsText(file);}, style: {width:"100%",background:C.bg3,border:"1px solid #2A3A54",borderRadius:8,padding:"8px",color:C.text,fontSize:13,cursor:"pointer"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 808}} )
            )
