...
console.log("%cNYC Driver Tracker — version v40","color:#00D4FF;font-weight:bold;font-size:14px");
...
var LICTYPES_ZH=["TLC 驾驶执照(2年·$252)","TLC 车辆执照FHV(1年)","DMV 驾驶执照","商业保险单","车辆注册","车辆年检(每4个月)","验毒证明($32)","指纹背景调查($90)","TLC 24小时培训课程","DDC防御驾驶课程(每3年)","WAV轮椅车辆培训","体检证明","FS-6T保险申报表","其他证件"];
var LICTYPES_EN=["TLC Driver License (2yr·$252)","TLC FHV Vehicle License (1yr)","DMV Driver License","Commercial Insurance","Vehicle Registration","Vehicle Inspection (every 4 mo)","Drug Test ($32)","Fingerprint Background Check ($90)","TLC 24-hour Training","DDC Defensive Driving Course (every 3yr)","WAV Wheelchair Vehicle Training","Medical Exam","FS-6T Insurance Form","Other License"];
...
function Card(p){return React.createElement('div', { className: "nyc-card", style: Object.assign({background:C.bg2,borderRadius:12,padding:"14px 16px",marginBottom:10,border:"1px solid "+C.border},p.style||{}), __self: this, __source: {fileName: _jsxFileName, lineNumber: 38}}, p.children);}
...
function App() {
  ...
  // edits, deletes, weekly logs, custGroups, etc. This watches everything.
  function autoSave(newData){
    // Kept for backward-compat; delegates to an immediate snapshot upload.
    if(!accessToken)return;
    var data=Object.assign({wl:wl,sl:sl,el:el,fl:fl,ll:ll,veh:veh,cc:cc,custGroups:custGroups,reminders:reminders,custPlat:custPlat,notes:notes,incGoal:incGoal,seRate:seRate,fedRate:fedRate,stateRate:stateRate,stdDed:stdDed},newData||{});
    saveToDrive(accessToken,driveFileId,data);
  }
  useEffect(function(){
    if(!accessToken)return;
    var t=setTimeout(function(){
      var data={wl:wl,sl:sl,el:el,fl:fl,ll:ll,veh:veh,cc:cc,custGroups:custGroups,reminders:reminders,custPlat:custPlat,notes:notes,incGoal:incGoal,seRate:seRate,fedRate:fedRate,stateRate:stateRate,stdDed:stdDed};
      saveToDrive(accessToken,driveFileId,data);
    },1500);
    return function(){clearTimeout(t);};
  },[accessToken,wl,sl,el,fl,ll,veh,cc,custGroups,reminders,custPlat,notes,incGoal,seRate,fedRate,stateRate,stdDed]);
...
React.createElement('div', { style: {minHeight:"100vh",background:C.bg2,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:24}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 204}}
  ...
  return (
      ...
      , React.createElement('div', { style: {background:C.bg,padding:"10px 14px 8px",borderBottom:"1px solid "+C.border}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 242}}
      ...
      , React.createElement('div', { style: {padding:"16px 14px",paddingBottom:100,maxWidth:800,margin:"0 auto"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 259}}
          ...
          React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 262}}
            ...
            , dashV==="month" ? (
              React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 265}}
                , React.createElement(MoNav, { val: mo, set: setMo, lang: lang, __self: this, __source: {fileName: _jsxFileName, lineNumber: 266}} )
            ...
            , dashV==="year" ? (
              React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 299}}
                , React.createElement(YrNav, { val: yr, set: setYr, lang: lang, __self: this, __source: {fileName: _jsxFileName, lineNumber: 300}} )
        ...
        , tab===1 ? (
          React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 319}}
            , React.createElement(MoNav, { val: mo, set: setMo, lang: lang, __self: this, __source: {fileName: _jsxFileName, lineNumber: 320}} )
          ...
          React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 342}}
            ...
            , expV==="month" ? (
              React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 345}}
                , React.createElement(MoNav, { val: mo, set: setMo, lang: lang, __self: this, __source: {fileName: _jsxFileName, lineNumber: 346}} )
                ...
                , React.createElement(BucketList, { items: feAll, allC: allC, lang: lang, el: el, setEl: setEl, emptyText: T.noData, onEditFixed: function(item){setEditFx({id:item.id,amount:item.amount,notes:item.notes||"",fixedLabel:item.fixedLabel});}, onEditExp: function(item){setEf(Object.assign({},item,{qty:item.qty||"",isRecurring:false}));setSf("exp_edit_"+item.id);}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 349}} )
              )
            ) : null
            , expV==="year" ? (
              React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 353}}
                , React.createElement(YrNav, { val: yr, set: setYr, lang: lang, __self: this, __source: {fileName: _jsxFileName, lineNumber: 354}} )
                ...
                , (function(){var allYE=yAllExps();if(!allYE.length)return React.createElement(Empty, { text: T.noData, __self: this, __source: {fileName: _jsxFileName, lineNumber: 356}} );return React.createElement(BucketList, { items: allYE, allC: allC, lang: lang, el: el, setEl: setEl, emptyText: "", onEditFixed: function(item){setEditFx({id:item.id,amount:item.amount,notes:item.notes||"",fixedLabel:item.fixedLabel});}, onEditExp: function(item){setEf(Object.assign({},item,{qty:item.qty||"",isRecurring:false}));setSf("exp_edit_"+item.id);}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 356}} );}())
        ...
        , tab===3 ? (
          React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 365}}
            ...
            , repP==="month" ? React.createElement(MoNav, { val: mo, set: setMo, lang: lang, __self: this, __source: {fileName: _jsxFileName, lineNumber: 367}} ) : React.createElement(YrNav, { val: yr, set: setYr, lang: lang, __self: this, __source: {fileName: _jsxFileName, lineNumber: 367}} )
      ...
      , sf && (sf==="exp" || sf.startsWith("exp_edit_")) ? (
        React.createElement(Modal, { title: sf.startsWith("exp_edit_")?(T.edit+" "+(lang==="en"?"Expense":"支出")):(lang==="en"?"Add Expense":"添加支出"), onClose: function(){setSf(null);}, onSave: function(){if(!ef.amount)return;if(sf.startsWith("exp_edit_")){var eid=+sf.replace("exp_edit_","");setEl(el.map(function(x){return x.id===eid?Object.assign({},ef,{id:eid}):x;}));}else if(ef.isRecurring){setFl(fl.concat([{id:Date.now(),label:allC[ef.category]?allC[ef.category].label:ef.notes||"Fixed",icon:allC[ef.category]?allC[ef.category].icon:"💼",cat:ef.category,cycle:"monthly",amount:ef.amount,day:new Date().getDate()+"",notes:ef.notes,active:true,startDate:"",endDate:"",maxCount:""}]));}else{var nel=[Object.assign({},ef,{id:Date.now()})].concat(el);setEl(nel);autoSave({el:nel});}setSf(null);}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 520}}
          ...
          , React.createElement('div', { onClick: function(){setEf(Object.assign({},ef,{isRecurring:!ef.isRecurring}));}, style: {display:"flex",alignItems:"center",gap:12,background:C.bg2,border:"1px solid "+C.border,borderRadius:10,padding:"12px 14px",cursor:"pointer"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 544}}
        ...
        React.createElement('div', { style: {position:"fixed",inset:0,background:"rgba(0,0,0,0.92)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:300,paddingBottom:"80px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 784}}
          , React.createElement('div', { style: {background:C.bg2,borderRadius:16,width:"100%",maxWidth:600,border:"1px solid "+C.border,maxHeight:"calc(90vh - 80px)",display:"flex",flexDirection:"column",overflow:"hidden"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 785}}
            ...
            , React.createElement('div', { style: {background:C.bg3,border:"1px solid "+C.border,borderRadius:12,padding:14,marginBottom:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 808}}
              ...
              , React.createElement('input', { type: "file", accept: ".json", onChange: function(e){var file=e.target.files[0];if(!file)return;if(!confirm(lang==="en"?"Merge data from this file? Existing entries will be kept.":"合并此文件中的数据？已有数据会保留。")){e.target.value="";return;}var reader=new FileReader();reader.onload=function(ev){try{var data=JSON.parse(ev.target.result);var added={el:0,sl:0,wl:0,fl:0,ll:0,reminders:0,notes:0};if(data.el&&data.el.length){setEl(el.concat(data.el));added.el=data.el.length;}if(data.sl&&data.sl.length){setSl(sl.concat(data.sl));added.sl=data.sl.length;}if(data.wl&&data.wl.length){setWl(wl.concat(data.wl));added.wl=data.wl.length;}if(data.fl&&data.fl.length){setFl(fl.concat(data.fl));added.fl=data.fl.length;}if(data.ll&&data.ll.length){setLl(ll.concat(data.ll));added.ll=data.ll.length;}if(data.reminders&&data.reminders.length){setReminders(reminders.concat(data.reminders));added.reminders=data.reminders.length;}if(data.notes&&data.notes.length){setNotes(notes.concat(data.notes));added.notes=data.notes.length;}var msg=lang==="en"?"Merged: "+added.el+" expenses, "+added.sl+" statements, "+added.wl+" weeks":"已合并："+added.el+" 笔支出, "+added.sl+" 月账单, "+added.wl+" 周记录";alert(msg);e.target.value="";}catch(err){alert(lang==="en"?"Invalid file":"文件格式错误");}};reader.readAsText(file);}, style: {width:"100%",background:C.bg3,border:"1px solid #2A3A54",borderRadius:8,padding:"8px",color:C.text,fontSize:13,cursor:"pointer"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 808}} )
            )
