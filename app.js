...
function App() {
  ...
  useEffect(function(){
    try{
      var u=localStorage.getItem("nyc_user"); if(u)setGUser(JSON.parse(u));
      var s=localStorage.getItem("nyc_sl"); if(s)setSl(JSON.parse(s));
      var e=localStorage.getItem("nyc_el"); if(e)setEl(JSON.parse(e));
      var f=localStorage.getItem("nyc_fl"); if(f)setFl(JSON.parse(f));
      var l=localStorage.getItem("nyc_ll"); if(l)setLl(JSON.parse(l));
      var v=localStorage.getItem("nyc_veh"); if(v)setVeh(JSON.parse(v));
      var n=localStorage.getItem("nyc_notes"); if(n)setNotes(JSON.parse(n));
      var ig=localStorage.getItem("nyc_incGoal"); if(ig)setIncGoal(ig);
    }catch(err){}
  },[]);

  // Save to localStorage when data changes
  useEffect(function(){try{localStorage.setItem("nyc_sl",JSON.stringify(sl));}catch(e){}}, [sl]);
  useEffect(function(){try{localStorage.setItem("nyc_el",JSON.stringify(el));}catch(e){}}, [el]);
  useEffect(function(){try{localStorage.setItem("nyc_fl",JSON.stringify(fl));}catch(e){}}, [fl]);
  useEffect(function(){try{localStorage.setItem("nyc_ll",JSON.stringify(ll));}catch(e){}}, [ll]);
  useEffect(function(){try{localStorage.setItem("nyc_veh",JSON.stringify(veh));}catch(e){}}, [veh]);
  useEffect(function(){try{localStorage.setItem("nyc_notes",JSON.stringify(notes));}catch(e){}}, [notes]);
  ...
  return (
      ...
      , React.createElement('div', { style: {padding:"16px 14px",paddingBottom:120,maxWidth:800,margin:"0 auto"}}
        ...
        , tab===0 ? (
          React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 262}}
            ...
            , dashV==="month" ? (
              React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 265}}
                ...
                , tInc > 0 ? React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 276}}
                ...
                , tExp > 0 ? (
                  React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 286}}
                    ...
                    , mExpDet ? React.createElement(Card, {__source: {fileName: _jsxFileName, lineNumber: 291}}, React.createElement(CatDetail, { items: feAll, total: tExp, allC: allC} )) : React.createElement(CatBreakdown, { items: feAll, total: tExp, allC: allC} )
            ...
            , dashV==="year" ? (
              React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 299}}
                ...
                , yExp > 0 ? React.createElement(Card, {__source: {fileName: _jsxFileName, lineNumber: 312}}, React.createElement('div', { style: {fontSize:14,fontWeight:700,color:C.text,marginBottom:12}}, lang==="en"?"Annual Expenses":"全年支出明细"), React.createElement(CatDetail, { items: yAllExps(), total: yExp, allC: allC} )) : null
              )
            ) : null
          )
        ) : null
        ...
        , tab===1 ? (
          React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 319}}
            , React.createElement(MoNav, { val: mo, set: setMo, lang: lang} )
        ...
        , tab===2 ? (
          React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 342}}
            , React.createElement(SegBtn, { val: expV, set: setExpV, opts: [["month",T.thisMonth],["year",T.thisYear]]} )
            , expV==="month" ? (
              React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 345}}
                , React.createElement(MoNav, { val: mo, set: setMo, lang: lang} )
            ...
            , expV==="year" ? (
              React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 353}}
                , React.createElement(YrNav, { val: yr, set: setYr, lang: lang} )
        ...
        , tab===3 ? (
          React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 365}}
            ...
            , (function(){var r=bldRep(repP),rn=r.rn;var rnCl=rn>=0?"#00E676":"#FF5252";return (
              React.createElement(Card, {__source: {fileName: _jsxFileName, lineNumber: 373}}
      ...
      , sf==="drawer_fixed" ? (
        React.createElement('div', { style: {position:"fixed",inset:0,background:C.bg,zIndex:300,overflowY:"auto"}}
          , React.createElement('div', { style: {maxWidth:600,margin:"0 auto",padding:"0 0 80px"}}
            ...
            , React.createElement('div', { style: {padding:"16px 14px"}}
              , fl.length > 0 ? React.createElement(Card, { style: {display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}, React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 474}}, React.createElement('div', { style: {fontSize:13,color:C.text,marginBottom:2}}, lang==="en"?"Monthly Fixed Total":"每月固定总支出"), React.createElement('div', { style: {fontSize:12,color:C.text2}}, fl.filter(function(f){return f.active;}).length, " " , lang==="en"?"active":"项启用")), React.createElement('div', { style: {fontSize:22,fontWeight:900,color:"#FF9A65"}}, fmt(totalFix))) : null
      ...
      , sf && (sf==="exp" || sf.startsWith("exp_edit_")) ? (
        React.createElement(Modal, { title: sf.startsWith("exp_edit_")?(T.edit+" "+(lang==="en"?"Expense":"支出")):(lang==="en"?"Add Expense":"添加支出"), onClose: function(){setSf(null);}, onSave: function(){if(!ef.amount)return;if(sf.startsWith("exp_edit_")){var eid=+sf.replace("exp_edit_","");setEl(el.map(function(x){return x.id===eid?Object.assign({},ef,{id:eid}):x;}));}else if(ef.isRecurring){setFl(fl.concat([{id:Date.now(),label:allC[ef.category]?allC[ef.category].label:ef.notes||"Fixed",icon:allC[ef.category]?allC[ef.category].icon:"💼",cat:ef.category,cycle:"monthly",amount:ef.amount,day:new Date().getDate()+"",notes:ef.notes,active:true,startDate:"",endDate:"",maxCount:""}]));}else{var nel=[Object.assign({},ef,{id:Date.now()})].concat(el);setEl(nel);autoSave({el:nel});}setSf(null);}}
          , React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 521}}
            ...
            , React.createElement('div', { style: {display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:8,marginBottom:14}}
              , [["车辆","&#128663;","#00D4FF","Vehicle"],["牌照","&#128203;","#FFD700","License"],["平台","&#128241;","#AB47BC","Platform"],["其他","&#128188;","#B0D4E8","Other"]].map(function(gb){
                ...
                return React.createElement('button', { key: gb[0], onClick: function(){setSelGrp(gb[0]);var first=Object.entries(allC).find(function(e){return e[1].g===gb[0];});if(first)setEf(Object.assign({},ef,{category:first[0]}));}, style: {padding:"8px 4px",borderRadius:10,border:"2px solid "+bdCol,background:bgCol,color:textCol,fontSize:12,fontWeight:fw,cursor:"pointer",textAlign:"center"}}
                  , React.createElement('div', { style: {fontSize:18,marginBottom:2}, dangerouslySetInnerHTML: {__html:gb[1]}} ), React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 528}}, lbl)
                );
              })
            )
            , React.createElement('div', { style: {display:"flex",gap:8,alignItems:"center"}}
          ...
          , React.createElement('div', { onClick: function(){setEf(Object.assign({},ef,{isRecurring:!ef.isRecurring}));}, style: {display:"flex",alignItems:"center",gap:12,background:"#0F1829",border:"1px solid #243550",borderRadius:10,padding:"12px 14px",cursor:"pointer"}}
            ...
            , React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 546}}, React.createElement('div', { style: {fontSize:14,fontWeight:600,color:C.text}}, T.fixedMonthly), React.createElement('div', { style: {fontSize:12,color:"#90B4D0",marginTop:2}}, T.fixedMonthlyDesc))
          )
        )
      ) : null
      ...
      , sf && (sf==="fixed" || sf.startsWith("fixed_edit_")) ? (
        React.createElement(Modal, { title: sf.startsWith("fixed_edit_")?(T.edit+" "+(lang==="en"?"Fixed":"固定")):(lang==="en"?"Add Fixed":"添加固定支出"), onClose: function(){setSf(null);}, onSave: function(){if(!ff.label||!ff.amount)return;if(sf.startsWith("fixed_edit_")){var eid=+sf.replace("fixed_edit_","");setFl(fl.map(function(x){return x.id===eid?Object.assign({},ff,{id:eid}):x;}));}else{var nfl=fl.concat([Object.assign({},ff,{id:Date.now(),active:true})]);setFl(nfl);autoSave({fl:nfl});}setSf(null);}}
          ...
          , React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 554}}, React.createElement('div', { style: {fontSize:14,color:C.text2,marginBottom:8}}, lang==="en"?"Icon":"图标"), React.createElement('div', { style: {display:"flex",flexWrap:"wrap",gap:5}}, ICONS.map(function(ic){var bdCol=ff.icon===ic?"#00D4FF":"#1A2A44",bgCol=ff.icon===ic?"#0A2040":"#111D30";return React.createElement('button', { key: ic, onClick: function(){setFf(Object.assign({},ff,{icon:ic}));}, style: {width:38,height:38,borderRadius:8,border:"2px solid "+bdCol,background:bgCol,fontSize:16,cursor:"pointer"}}, ic);}), " " ))
      ...
      , sf==="cc" ? (
        React.createElement(Modal, { title: cf._editKey?(lang==="en"?"Edit Category":"编辑类别"):(lang==="en"?"Add Category":"添加类别"), onClose: function(){setSf(cf._returnTo||null);}, onSave: function(){if(!cf.label.trim())return;var key=cf._editKey||"cc_"+Date.now(),newCat={label:cf.label.trim(),icon:cf.icon,group:cf.group,g:cf.group},newCc=Object.assign({},cc);newCc[key]=newCat;setCc(newCc);if(cf._returnTo==="exp"){setEf(Object.assign({},ef,{category:key}));setSelGrp(cf.group);setSf("exp");}else{setSf(null);}}}
          ...
          , React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 582}}, React.createElement('div', { style: {fontSize:14,color:C.text2,marginBottom:8}}, lang==="en"?"Icon":"图标"), React.createElement('div', { style: {display:"flex",flexWrap:"wrap",gap:5}}, ICONS.map(function(ic){var bdCol=cf.icon===ic?"#00D4FF":"#1A2A44",bgCol=cf.icon===ic?"#0A2040":"#111D30";return React.createElement('button', { key: ic, onClick: function(){setCf(Object.assign({},cf,{icon:ic}));}, style: {width:38,height:38,borderRadius:8,border:"2px solid "+bdCol,background:bgCol,fontSize:16,cursor:"pointer"}}, ic);}), " " ))
      ...
      , sf==="notes" ? (
        React.createElement('div', { style: {position:"fixed",inset:0,background:C.bg,zIndex:300,overflowY:"auto"}}
          , React.createElement('div', { style: {maxWidth:600,margin:"0 auto",padding:"0 0 80px"}}
            ...
            , React.createElement('div', { style: {padding:"16px 14px"}}
              , noteEdit ? React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 630}}
              ...
              ) : React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 640}}
            ...
            , React.createElement('div', { style: {padding:"16px 14px"}}
              ...
              , React.createElement(Card, { style: {marginBottom:12,padding:"12px 14px"}}
                , React.createElement('div', { style: {display:"flex",justifyContent:"space-between",alignItems:"center"}}
                  , React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 691}}, React.createElement('div', { style: {fontSize:13,fontWeight:700}}, lang==="en"?"SE Tax Rate":"自雇税率"), React.createElement('div', { style: {fontSize:11,color:C.text3,marginTop:2}}, taxRateNote||"IRS "+taxYr))
              ...
              , (function(){
                ...
                return React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 714}}
                  ...
                  , React.createElement(Card, { style: {marginBottom:10}}, React.createElement('div', { style: {fontSize:14,fontWeight:800,color:"#FFB300",marginBottom:10}}, "📅 " , lang==="en"?"Quarterly Tax":"季度预缴")
                    , ["Q1 (Jan-Mar)","Q2 (Apr-May)","Q3 (Jun-Aug)","Q4 (Sep-Dec)"].map(function(q,i){var isCur=i===qNum-1,isPast=i<qNum-1;return React.createElement('div', { key: i, style: {display:"flex",justifyContent:"space-between",padding:"7px 0",borderBottom:"1px solid #1E3050"}}, React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 727}}, React.createElement('div', { style: {fontSize:13,fontWeight:700,color:isCur?"#FFD700":isPast?"#7A9AB8":C.text}}, q), React.createElement('div', { style: {fontSize:11,color:"#7A9AB8"}}, lang==="en"?"Due: ":"截止: ", qDates[i])), React.createElement('div', { style: {textAlign:"right"}}, React.createElement('div', { style: {fontSize:14,fontWeight:800,color:isCur?"#FFD700":C.text2}}, fmt(qDue)), React.createElement('div', { style: {fontSize:11,color:isPast?"#00E676":isCur?"#FFB300":"#7A9AB8"}}, isPast?"✓"+(lang==="en"?" Past":" 已过"):isCur?(lang==="en"?"← Now":"← 当前"):(lang==="en"?"Upcoming":"待缴"))));})
                  )
      ...
      , showRemMgr ? (
        React.createElement('div', { style: {position:"fixed",inset:0,background:"rgba(0,0,0,0.92)",display:"flex",alignItems:"flex-end",justifyContent:"center",zIndex:300}}
          , React.createElement('div', { style: {background:C.bg2,borderRadius:"20px 20px 0 0",padding:"24px 20px 52px",width:"100%",maxWidth:600,border:"1px solid "+C.border,borderBottom:"none",maxHeight:"85vh",overflowY:"auto"}}
            ...
            , reminders.length>0 ? React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 758}}
        ...
        React.createElement('div', { style: {position:"fixed",inset:0,background:"rgba(0,0,0,0.92)",display:"flex",alignItems:"flex-end",justifyContent:"center",zIndex:300}}
          , React.createElement('div', { style: {background:C.bg2,borderRadius:"20px 20px 0 0",padding:"24px 20px 48px",width:"100%",maxWidth:600,border:"1px solid "+C.border,borderBottom:"none",maxHeight:"90vh",overflowY:"auto"}}
            ...
            , React.createElement('div', { style: {background:"#0A1828",border:"1px solid #1A3048",borderRadius:12,padding:16,marginBottom:12}}
              ...
              , gUser&&accessToken ? React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 793}}
        ...
        React.createElement('div', { style: {position:"fixed",inset:0,background:C.bg,zIndex:300,overflowY:"auto"}}
          , React.createElement('div', { style: {maxWidth:600,margin:"0 auto",padding:"0 0 60px"}}
            , React.createElement('div', { style: {background:C.bg2,padding:"18px",borderBottom:"1px solid "+C.border,display:"flex",justifyContent:"space-between",alignItems:"center",position:"sticky",top:0,zIndex:10}}
              , React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 839}}, React.createElement('div', { style: {fontSize:16,fontWeight:800}}, reportData.type==="exp"?(lang==="en"?"&#128184; Expense Detail":"&#128184; 支出明细"):(lang==="en"?"&#128202; Financial Report":"&#128202; 财务报告")), React.createElement('div', { style: {fontSize:13,color:"#90B4D0"}}, reportData.label))
            ...
            , React.createElement('div', { style: {padding:"20px 16px 0",fontFamily:"monospace"}}
              ...
              , reportData.type==="exp" ? (
                React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 849}}
                ...
                React.createElement('div', {__source: {fileName: _jsxFileName, lineNumber: 862}}
