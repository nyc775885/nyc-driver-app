...
console.log("%cNYC Driver Tracker — version v157","color:#00D4FF;font-weight:bold;font-size:14px");
...
const _jsxFileName = "";var useState = React.useState; var useEffect = React.useEffect;
...
var C={bg:"#141C2E",bg2:"#1F2A42",bg3:"#283550",border:"#3A4D6E",text:"#F0F4FF",text2:"#C8E4F8",text3:"#A8C2DC"};
...
function BucketList(p){
  ...
  var toggle=function(k){__bucketExpanded[k]=!__bucketExpanded[k];forceRerender();};
  ...
  return React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 49}}, ["车辆","牌照","平台","其他"].map(function(bk){
    ...
    return React.createElement('div', { key: bk, style: {marginBottom:18}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 49}}
      ...
      , catKeys.map(function(ck){
        var cat=byCat[ck];
        var groupKey=bk+"|"+ck;
        var isExp=__bucketExpanded[groupKey];
        if(cat.items.length===1){
          var item=cat.items[0];
          return React.createElement(ExpItem, { key: item.id, item: item, allC: aC, lang: p.lang, distFromLast: distMap[item.id]||null, onDel: function(){if(!confirm(p.lang==="en"?"Delete this expense?":"确认删除这笔支出？"))return;p.setEl(p.el.filter(function(x){return x.id!==item.id;}));}, onEdit: function(){if(item.isFixed){p.onEditFixed&&p.onEditFixed(item);}else{p.onEditExp&&p.onEditExp(item);}}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 49}} );
        }
        return React.createElement('div', { key: ck, style: {marginBottom:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 49}}
          , React.createElement('button', { onClick: function(){toggle(groupKey);}, style: {width:"100%",background:C.bg2,border:"1px solid "+C.border,borderRadius:10,padding:"10px 14px",display:"flex",justifyContent:"space-between",alignItems:"center",cursor:"pointer",marginBottom:isExp?8:0}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 49}}
            , React.createElement('div', { style: {display:"flex",alignItems:"center",gap:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 49}}
              ...
              , React.createElement('div', { style: {textAlign:"left"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 49}}
                ...
                , React.createElement('div', { style: {fontSize:11,color:C.text3}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 49}}, cat.items.length+" "+(p.lang==="en"?(cat.items.length===1?"entry":"entries"):"笔"))
              )
            )
          ...
          , isExp ? React.createElement('div', { style: {paddingLeft:8}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 49}}
            , cat.items.map(function(item){return React.createElement(ExpItem, { key: item.id, item: item, allC: aC, lang: p.lang, distFromLast: distMap[item.id]||null, onDel: function(){if(!confirm(p.lang==="en"?"Delete this expense?":"确认删除这笔支出？"))return;p.setEl(p.el.filter(function(x){return x.id!==item.id;}));}, onEdit: function(){if(item.isFixed){p.onEditFixed&&p.onEditFixed(item);}else{p.onEditExp&&p.onEditExp(item);}}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 49}} );})
          ) : null
        );
      })
    );
...
function CatBreakdown(p){if(!p.items.length)return null;var cm={};p.items.forEach(function(e){var k=e.isFixed?"fx_"+e.fixedLabel:e.category,cat=p.allC[e.category],lbl=e.isFixed?e.fixedLabel:(cat?cat.label:"其他"),ico=e.isFixed?e.fixedIcon:getIcon(e.category,p.allC);if(!cm[k]){cm[k]={label:lbl,icon:ico,total:0,count:0};}cm[k].total+=(+e.amount||0);cm[k].count++;});var sorted=Object.values(cm).sort(function(a,b){return b.total-a.total;}),mx=sorted[0]?sorted[0].total:1;var isEn=p.lang==="en";return React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 50}}, sorted.map(function(c){var pct=Math.round(c.total/p.total*100),bw=Math.max(3,Math.round(c.total/mx*100))+"%";return React.createElement('div', { key: c.label, style: {marginBottom:12}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 50}}, React.createElement('div', { style: {display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:4}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 50}}, React.createElement('span', { style: {fontSize:14,color:C.text}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 50}}, c.icon, " " , c.label, React.createElement('span', { style: {fontSize:11,color:C.text3,marginLeft:6}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 50}}, "×", c.count)), React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 50}}, React.createElement('span', { style: {fontSize:14,fontWeight:700,color:"#FF9A65"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 50}}, fmt(c.total)), React.createElement('span', { style: {fontSize:12,color:"#B8D8EC",marginLeft:5}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 50}}, pct, "%"))), React.createElement('div', { style: {height:5,borderRadius:3,background:"#1A2A44"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 50}}, React.createElement('div', { style: {height:5,borderRadius:3,width:bw,background:"linear-gradient(90deg,#FF6B35,#FF9A65)"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 50}})));}));}
...
function App() {
  ...
  var r18=useState({weekStart:wkMon(today()),platform:"Uber",trips:"",hours:"",onlineHours:"",miles:"",grossFare:"",tips:"",bonus:"",tollReimbursed:"",notes:""});
  ...
  var r54=useState({date:today(),cash:"",card:"",tips:"",trips:"",hours:"",miles:"",lease:"",notes:""}),dlf=r54[0],setDlf=r54[1];
  ...
  useEffect(function(){
    if(wizStep===0) return;
    if(sf!==null) return;
    if(wizStep===2){ setSf("drawer_lic"); setWizStep(3); }
    else if(wizStep===3){
      if(driverType==="taxi"){
        setDlf({date:today(),cash:"",card:"",tips:"",trips:"",hours:"",miles:"",lease:"",notes:""});
        setSf("daily");
      } else {
        setStf({month:curMo(),platform:"Uber",grossFare:"",tips:"",bonus:"",tollReimbursed:"",otherIncome:"",trips:"",onlineHours:"",miles:"",acceptRate:"",completionRate:"",notes:""});
        setSf("stmt");
      }
      setWizStep(4);
    }
    else if(wizStep===4){ setWizStep(0); }  // done
  ...
  var mWeeks=wl.filter(function(w){return w.weekStart.slice(0,7)===mo;});
  ...
  var mDailies=dl.filter(function(d){return d.date&&d.date.slice(0,7)===mo;});var mDailyInc=mDailies.reduce(function(s,d){return s+(+d.cash||0)+(+d.card||0)+(+d.tips||0);},0);var mDailyLease=mDailies.reduce(function(s,d){return s+(+d.lease||0);},0);var tInc=mStmts.reduce(function(s,x){return s+(+x.grossFare||0)+(+x.tips||0)+(+x.bonus||0)+(+x.tollReimbursed||0)+(+x.otherIncome||0);},0)+mDailyInc;
  // For taxi mode: cash+card maps to grossFare; tips maps to tips
  var mDlCash=mDailies.reduce(function(s,d){return s+(+d.cash||0);},0);
  var mDlCard=mDailies.reduce(function(s,d){return s+(+d.card||0);},0);
  var mDlTipsSum=mDailies.reduce(function(s,d){return s+(+d.tips||0);},0);
  var tGross=mStmts.reduce(function(s,x){return s+(+x.grossFare||0);},0)+mDlCash+mDlCard,tTips=mStmts.reduce(function(s,x){return s+(+x.tips||0);},0)+mDlTipsSum;
  ...
  var tExp=feAll.reduce(function(s,e){return s+(+e.amount||0);},0)+mDailyLease,tFix=fixMo.reduce(function(s,e){return s+(+e.amount||0);},0),net=tInc-tExp;
  ...
  var yDailies=dl.filter(function(d){return d.date&&d.date.slice(0,4)===yr;});var yDailyInc=yDailies.reduce(function(s,d){return s+(+d.cash||0)+(+d.card||0)+(+d.tips||0);},0);var yDailyLease=yDailies.reduce(function(s,d){return s+(+d.lease||0);},0);var yInc=yStmts.reduce(function(s,x){return s+(+x.grossFare||0)+(+x.tips||0)+(+x.bonus||0)+(+x.tollReimbursed||0)+(+x.otherIncome||0);},0)+yDailyInc;
  var yExp=yExps.reduce(function(s,e){return s+(+e.amount||0);},0)+yFixT+yDailyLease,yNet=yInc-yExp;
  ...
  // Helper: read/write the goal for a specific month
  ...
  function setIncGoal(v){
    ...
    setIncGoals(nx);
  } var r52=useState(false),showGoal=r52[0],setShowGoal=r52[1]; var r52b=useState(false),showDP=r52b[0],setShowDP=r52b[1]; var r52c=useState(false),showTP=r52c[0],setShowTP=r52c[1]; var r52d=useState(null),mpState=r52d[0],setMpState=r52d[1]; var r52z=useState(false),trendOpen=r52z[0],setTrendOpen=r52z[1]; var r52y=useState(0),_forceCount=r52y[0],_setForceCount=r52y[1]; var forceRerender=function(){_setForceCount(function(x){return x+1;});};
  ...
  function getDriveData(tok,cb){
    ...
    getOrCreateFolder(tok,function(folderId){
      ...
      .then(function(r){return r.json();})
      .then(function(d){
        if(d.files&&d.files.length>0){cb(d.files[0].id,folderId,d.files[0].modifiedTime);}else{cb(null,folderId,null);}
  ...
  function loadFromDrive(tok){
    ...
    getDriveData(tok,function(fileId,folderId,modTime){
      ...
      .then(function(data){
        ...
        if(data.incGoals && typeof data.incGoals === "object") setIncGoals(data.incGoals); else if(typeof data.incGoal!=="undefined" && data.incGoal!=="") { var d=new Date(),cm=d.getFullYear()+"-"+(d.getMonth()+1<10?"0":"")+(d.getMonth()+1); var g={}; g[cm]=String(data.incGoal); setIncGoals(g); }
        ...
        if(typeof data.stdDed==="number")setStdDed(data.stdDed);if(Array.isArray(data.dl))setDl(data.dl);if(data.driverType==="rideshare"||data.driverType==="taxi")setDriverType(data.driverType);
  ...
  },[wl,sl,el,fl,ll,veh,cc,custGroups,reminders,custPlat,custBrands,custLicTypes,custLoanTypes,favNotes,notes,incGoals,seRate,fedRate,stateRate,stdDed,dl,driverType]);
    ...
    getDriveData(accessToken,function(fileId,folderId,driveModTime){
      ...
      .then(function(cloudData){
        ...
        if(cloudModTime > localModTime){
          ...
          if(cloudData.veh)setVeh(cloudData.veh);
          ...
          if(cloudData.incGoals && typeof cloudData.incGoals === "object") setIncGoals(cloudData.incGoals); else if(typeof cloudData.incGoal!=="undefined" && cloudData.incGoal!=="") { var d=new Date(),cm=d.getFullYear()+"-"+(d.getMonth()+1<10?"0":"")+(d.getMonth()+1); var g={}; g[cm]=String(cloudData.incGoal); setIncGoals(g); }
  ...
  return (
      ...
      , React.createElement('div', { style: {background:C.bg,padding:"10px 14px 8px",borderBottom:"1px solid "+C.border,position:"sticky",top:0,zIndex:50}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 242}}
        , React.createElement('div', { style: {display:"flex",alignItems:"center",gap:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 243}}
          ...
          , React.createElement('div', { style: {flex:1,textAlign:"center"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 245}}
            , veh.brand||veh.plate ? React.createElement('div', { style: {fontSize:13,fontWeight:800,color:C.text}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 246}}, veh.year?veh.year+" ":"", veh.brand?veh.brand+" ":"", veh.model?veh.model+" ":"", veh.plate?"["+veh.plate+"]":"") : React.createElement('div', { style: {fontSize:13,fontWeight:700,color:C.text3}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 246}}, "NYC RIDESHARE TRACKER"  )
            , React.createElement('div', { style: {fontSize:12,color:C.text3,letterSpacing:0.5}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 247}}, "NYC DRIVER TRACKER"  )
          )
          , React.createElement('button', { onClick: function(){setLang(lang==="zh"?"en":"zh");}, style: {background:"#1A2A44",border:"none",borderRadius:6,color:"#A8D0E8",fontSize:11,cursor:"pointer",padding:"3px 7px",fontWeight:700,flexShrink:0}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 249}}, lang==="zh"?"EN":"中")
          , React.createElement('button', { onClick: function(){setShowRemMgr(true);}, style: {background:"none",border:"none",color:"#CC88FF",fontSize:18,cursor:"pointer",padding:"2px 6px",flexShrink:0}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 250}}, "🔔")
        )
      )
      ...
      , React.createElement('div', { style: {padding:"16px 14px",paddingBottom:100,maxWidth:800,margin:"0 auto"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 259}}
          ...
          React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 262}}
            ...
            , dashV==="month" ? (
              React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 265}}
                ...
                , (function(){var hm=mData.filter(function(m){return m.inc>0;});if(hm.length<2)return null;var mx=Math.max.apply(null,hm.map(function(m){return m.inc;}));return React.createElement(Card, { style: {marginBottom:8,padding:"12px 14px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 268}}, React.createElement('div', { style: {fontSize:13,fontWeight:700,color:C.text2,marginBottom:8}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 268}}, "📊 " , lang==="en"?("Income Trend · "+yr):("收入趋势 · "+yr+"年")), React.createElement('div', { style: {display:"flex",alignItems:"center",gap:3,height:60}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 268}}, mData.map(function(m,i){if(!m.inc)return React.createElement('div', { key: i, style: {flex:1}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 268}} );var h=Math.round(8+m.inc/mx*48);var isCur=m.m===mo;return React.createElement('div', { key: i, onClick: function(){setMo(m.m);setDashV("month");}, style: {flex:1,cursor:"pointer"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 268}}, React.createElement('div', { style: {width:"100%",height:h,borderRadius:"3px 3px 0 0",background:isCur?"#00D4FF":m.net>=0?"#00E676":"#FF5252",opacity:isCur?1:0.7}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 268}} ));}), " " ), React.createElement('div', { style: {display:"flex",fontSize:10,color:C.text3,marginTop:3}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 268}}, mData.map(function(m,i){return React.createElement('div', { key: i, style: {flex:1,textAlign:"center",color:m.m===mo?"#00D4FF":"#7A9AB8"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 268}}, m.label.slice(0,3));})));}())
                , React.createElement(Card, { style: {marginBottom:10,padding:"12px 14px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 269}}
                  , React.createElement('div', { style: {display:"flex",justifyContent:"space-between",alignItems:"center",gap:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 270}}
                    , React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 270}}
                      , React.createElement('div', { style: {fontSize:11,color:"#8ACCA8"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 270}}, T.netIncome)
                      , (function(){var nc=net>=0?"#5AB078":"#C04848";return React.createElement('div', { style: {fontSize:20,fontWeight:700,color:nc,letterSpacing:-0.5,marginTop:2}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 271}}, fmt(net));}())
                    )
                    , React.createElement('div', { style: {textAlign:"right",fontSize:11,color:"#8ACCA8",lineHeight:1.5}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 272}}
                      , React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 272}}, lang==="en"?"In ":"收 ", fmt(tInc))
                      , React.createElement('div', { style: {color:"#FF6B35"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 272}}, lang==="en"?"Out ":"支 ", fmt(tExp))
                      , tInc>0&&tExp>0 ? React.createElement('div', { style: {color:"#5A8A6A",fontSize:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 272}}, Math.round(net/tInc*100), "% " , lang==="en"?"profit":"利润") : null
                    )
                  )
                )
                ...
                , (function(){
                  ...
                  return React.createElement(Card, { style: {marginBottom:8,padding:"12px 14px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 282}}
                    ...
                    , mStats?React.createElement('div', { style: {marginBottom:yStats?10:0}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 282}}
                      , React.createElement('div', { style: {fontSize:11,color:C.text3,marginBottom:4}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 282}}, lang==="en"?"This Month":"本月")
                ...
                , (function(){
                  ...
                  return React.createElement(Card, { style: {marginBottom:8,padding:"12px 14px",cursor:"pointer"}, onClick: function(){setTrendOpen(!trendOpen);}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 281}}
                    , React.createElement('div', { style: {display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 281}}
                      , React.createElement('div', { style: {fontSize:13,fontWeight:700,color:"#FFD700"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 281}}, "⛽ " , lang==="en"?(isEv?"Charging · "+fi.length+" fills":"Gas · "+fi.length+" fills"):(isEv?"充电 · "+fi.length+" 次":"加油 · "+fi.length+" 次"))
                    ...
                    , trendOpen ? React.createElement('div', { style: {marginTop:12,paddingTop:10,borderTop:"1px solid "+C.border}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 281}}
                      , React.createElement('div', { style: {fontSize:11,color:C.text3,marginBottom:6}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 281}}, lang==="en"?"All "+fi.length+" fills this month":"本月 "+fi.length+" 次充电详情")
                      , pts.slice().reverse().map(function(p,i){var isMax=p.price===maxP,isMin=p.price===minP;var col=isMax?"#FF6B35":isMin?"#00E676":C.text;return React.createElement('div', { key: i, style: {display:"flex",justifyContent:"space-between",padding:"6px 0",borderBottom:i<pts.length-1?"1px solid "+C.border:"none",fontSize:13}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 281}}
                        ...
                        , React.createElement('span', { style: {color:C.text3,fontSize:11,marginRight:8}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 281}}, fmt2(p.qty), unitName)
        ...
        , tab===1 ? (
                    ...
                    , React.createElement('div', { style: {display:"flex",justifyContent:"space-between",alignItems:"flex-start"} }
                      , React.createElement('div', { style: {flex:1} }
                        ...
                        , React.createElement('div', { style: {display:"flex",gap:6,flexWrap:"wrap",marginTop:4} }
                          , d.cash ? React.createElement('span', { style: {fontSize:11,background:"#0A2010",borderRadius:6,padding:"2px 7px",color:"#5ADA7A"} }, "💵 ", fmt(+d.cash||0)) : null
                          , d.card ? React.createElement('span', { style: {fontSize:11,background:"#0A1828",borderRadius:6,padding:"2px 7px",color:"#5AACFF"} }, "💳 ", fmt(+d.card||0)) : null
                          , d.tips ? React.createElement('span', { style: {fontSize:11,background:"#1A1400",borderRadius:6,padding:"2px 7px",color:"#FFD700"} }, "💰 ", fmt(+d.tips||0)) : null
                          , d.trips ? React.createElement('span', { style: {fontSize:11,background:"#1A2A44",borderRadius:6,padding:"2px 7px",color:C.text2} }, d.trips, " ", T.trips) : null
                          , d.hours ? React.createElement('span', { style: {fontSize:11,background:"#1A2A44",borderRadius:6,padding:"2px 7px",color:C.text2} }, d.hours, "h") : null
                          , d.miles ? React.createElement('span', { style: {fontSize:11,background:"#1A2A44",borderRadius:6,padding:"2px 7px",color:C.text2} }, d.miles, "mi") : null
                        )
                      )
          ...
          React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 319}}
            , React.createElement(MoNav, { val: mo, set: setMo, lang: lang, onPick: function(){setMpState({value:mo,onChange:function(v){setMo(v);}});}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 320}} )
            , React.createElement('button', { onClick: function(){setPasteUberText("");setPasteUberResult(null);setShowPasteUber(true);}, style: {width:"100%",background:"linear-gradient(135deg,#0A2858,#1A4080)",border:"1px solid #4A7AC0",borderRadius:10,padding:"10px 14px",color:"#9ACEFF",fontSize:13,fontWeight:700,cursor:"pointer",marginBottom:10,display:"flex",justifyContent:"space-between",alignItems:"center",boxShadow:"0 1px 4px rgba(74,122,192,0.25)"} }
              , React.createElement('span', null, "📄 " , lang==="en"?"Paste Uber Weekly Statement":"粘贴 Uber 周报")
              , React.createElement('span', {style:{color:"#3A6080",fontSize:14}}, "→")
            )
            , React.createElement('button', { onClick: function(){setPasteUberTaxText("");setPasteUberTaxResult(null);setShowPasteUberTax(true);}, style: {width:"100%",background:"#1A1000",border:"1px solid #3A2800",borderRadius:10,padding:"10px 14px",color:"#FFB300",fontSize:13,fontWeight:700,cursor:"pointer",marginBottom:10,display:"flex",justifyContent:"space-between",alignItems:"center"} }
              , React.createElement('span', null, "📊 " , lang==="en"?"Paste Uber Annual Tax Summary":"粘贴 Uber 年度税务总结")
            ...
            , React.createElement('div', { style: {display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:16}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 321}}
              , React.createElement('button', { onClick: function(){setStf({month:mo,platform:"Uber",grossFare:"",tips:"",bonus:"",tollReimbursed:"",otherIncome:"",trips:"",onlineHours:"",miles:"",notes:""});setSf("stmt");}, style: {background:C.bg3,border:"1px solid "+C.border,borderRadius:14,padding:"16px 12px",cursor:"pointer",textAlign:"center"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 322}}
                , React.createElement('div', { style: {fontSize:28,marginBottom:6}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 323}}, "💵")
                , React.createElement('div', { style: {fontSize:14,fontWeight:800,color:C.text2,marginBottom:4}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 324}}, T.monthly)
                , React.createElement('div', { style: {fontSize:12,color:C.text3}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 325}}, "Uber/Lyft " , T.monthly)
              )
              , React.createElement('button', { onClick: function(){setSf("week");}, style: {background:C.bg3,border:"1px solid "+C.border,borderRadius:14,padding:"16px 12px",cursor:"pointer",textAlign:"center"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 327}}
                , React.createElement('div', { style: {fontSize:28,marginBottom:6}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 328}}, "📅")
                , React.createElement('div', { style: {fontSize:14,fontWeight:800,color:"#00E676",marginBottom:4}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 329}}, T.weekly)
          ...
          React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 342}}
            ...
            , expV==="month" ? (
              React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 345}}
                ...
                , React.createElement(BucketList, { items: feAll, allC: allC, lang: lang, el: el, setEl: setEl, allEl: el, forceRerender: forceRerender, emptyText: T.noData, onEditFixed: function(item){setEditFx({id:item.id,amount:item.amount,notes:item.notes||"",fixedLabel:item.fixedLabel});}, onEditExp: function(item){setEf(Object.assign({},item,{qty:item.qty||"",isRecurring:false}));setSf("exp_edit_"+item.id);}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 349}} )
              )
            ) : null
            , expV==="year" ? (
          ...
          , React.createElement('div', { style: {maxWidth:600,margin:"0 auto",padding:"0 0 80px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 390}}
            ...
            , React.createElement('div', { style: {padding:"16px 14px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 395}}
              ...
              , React.createElement('div', { style: {display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:8}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 395}}
                ...
                , React.createElement(Field, { label: lang==="en"?"Phone":"电话", type: "tel", value: (veh.driver&&veh.driver.phone)||"", onChange: function(v){setVeh(Object.assign({},veh,{driver:Object.assign({},veh.driver||{},{phone:v})}));}, placeholder: "(347) 555-0100", __self: this, __source: {fileName: _jsxFileName, lineNumber: 395}} )
                , React.createElement(Field, { label: lang==="en"?"TLC Hack #":"TLC 驾照号", value: (veh.driver&&veh.driver.tlcHack)||"", onChange: function(v){setVeh(Object.assign({},veh,{driver:Object.assign({},veh.driver||{},{tlcHack:v})}));}, placeholder: "6-digit", __self: this, __source: {fileName: _jsxFileName, lineNumber: 395}} )
                , React.createElement(Field, { label: lang==="en"?"DMV License #":"DMV 驾照号", value: (veh.driver&&veh.driver.dmvLic)||"", onChange: function(v){setVeh(Object.assign({},veh,{driver:Object.assign({},veh.driver||{},{dmvLic:v.toUpperCase()})}));}, placeholder: "NY DMV #", __self: this, __source: {fileName: _jsxFileName, lineNumber: 395}} )
              )
              , React.createElement(Field, { label: "Email", type: "email", value: (veh.driver&&veh.driver.email)||"", onChange: function(v){setVeh(Object.assign({},veh,{driver:Object.assign({},veh.driver||{},{email:v})}));}, placeholder: "you@example.com", __self: this, __source: {fileName: _jsxFileName, lineNumber: 395}} )
              , React.createElement('div', { style: {fontSize:12,fontWeight:600,color:C.text3,marginTop:10,marginBottom:6}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 395}}, lang==="en"?"Emergency Contact":"紧急联系人")
              , React.createElement('div', { style: {display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 395}}
                , React.createElement(Field, { label: lang==="en"?"Name":"姓名", value: (veh.driver&&veh.driver.emergName)||"", onChange: function(v){setVeh(Object.assign({},veh,{driver:Object.assign({},veh.driver||{},{emergName:v})}));}, placeholder: lang==="en"?"Spouse / Family":"配偶 / 亲属", __self: this, __source: {fileName: _jsxFileName, lineNumber: 395}} )
                , React.createElement(Field, { label: lang==="en"?"Phone":"电话", type: "tel", value: (veh.driver&&veh.driver.emergPhone)||"", onChange: function(v){setVeh(Object.assign({},veh,{driver:Object.assign({},veh.driver||{},{emergPhone:v})}));}, placeholder: "(347) 555-0200", __self: this, __source: {fileName: _jsxFileName, lineNumber: 395}} )
              )
              , React.createElement('div', { style: {height:1,background:C.border,margin:"20px 0"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 395}})
              ...
              , (function(){
                ...
                return React.createElement('div', { style: {background:"#0A1828",border:"1px solid #2A4A6A",borderRadius:10,padding:"12px 14px",marginTop:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 405}}
                  , React.createElement('div', { style: {fontSize:11,color:C.text3,marginBottom:4}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 405}}, "🛣 " , lang==="en"?"Current Mileage":"当前总里程")
                  ...
                  , React.createElement('div', { style: {fontSize:11,color:C.text3,marginTop:2}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 405}}, lang==="en"?"As of ":"截至 ", fmtDate(lastOdo.date))
                );
              }())
      ...
      , sf==="daily" ? (
        React.createElement(Modal, { title: dlf.id?(lang==="en"?"Edit Day":"编辑当日"):(lang==="en"?"Today\'s Income":"今日收入"), onClose: function(){setSf(null);}, onSave: function(){
          ...
          , dlf.id ? React.createElement('button', { onClick: function(){if(!confirm(lang==="en"?"Delete this entry?":"确认删除？"))return;setDl(dl.filter(function(x){return x.id!==dlf.id;}));setSf(null);}, style: {width:"100%",background:"#2A1010",border:"1px solid #5A2020",color:"#FF7060",fontSize:14,fontWeight:700,padding:"12px",borderRadius:10,cursor:"pointer",marginTop:8} }, "🗑 " , T.del) : null
        )
      ) : null

      , sf==="week" ? (
        React.createElement(Modal, { title: T.weekly, onClose: function(){setSf(null);setWf({weekStart:wkMon(today()),platform:"Uber",trips:"",hours:"",onlineHours:"",miles:"",grossFare:"",tips:"",bonus:"",tollReimbursed:"",notes:""});}, onSave: function(){if(!wf.trips&&!wf.hours&&!wf.miles&&!wf.grossFare)return;var ws=wkMon(wf.weekStart);if(wf.id){setWl(wl.map(function(x){return x.id===wf.id?Object.assign({},wf,{weekStart:ws}):x;}));}else{var ex=wl.find(function(w){return w.weekStart===ws&&w.platform===wf.platform;});if(ex){setWl(wl.map(function(w){return w.id===ex.id?Object.assign({},wf,{weekStart:ws,id:ex.id}):w;}));}else{var nwl=[Object.assign({},wf,{weekStart:ws,id:Date.now()})].concat(wl);setWl(nwl);autoSave({sl:sl,el:el,fl:fl});}}setSf(null);}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 483}}
          ...
          , React.createElement(Field, { label: T.platform_lbl, value: wf.platform, onChange: function(v){setWf(Object.assign({},wf,{platform:v}));}, options: allPlat.map(function(p){return [p,p];}), __self: this, __source: {fileName: _jsxFileName, lineNumber: 486}} )
          , React.createElement('div', { style: {fontSize:13,color:C.text3,marginTop:4,marginBottom:-4}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 486}}, "💵 " , lang==="en"?"Income":"收入")
          , React.createElement(Field, { label: T.grossFare+" ($)", type: "number", value: wf.grossFare, onChange: function(v){setWf(Object.assign({},wf,{grossFare:v}));}, money: true, placeholder: "0.00", __self: this, __source: {fileName: _jsxFileName, lineNumber: 486}} )
          , React.createElement('div', { style: {display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 486}}
            , React.createElement(Field, { label: T.tips+" ($)", type: "number", value: wf.tips, onChange: function(v){setWf(Object.assign({},wf,{tips:v}));}, money: true, placeholder: "0.00", __self: this, __source: {fileName: _jsxFileName, lineNumber: 486}} )
            , React.createElement(Field, { label: T.bonus+" ($)", type: "number", value: wf.bonus, onChange: function(v){setWf(Object.assign({},wf,{bonus:v}));}, money: true, placeholder: "0.00", __self: this, __source: {fileName: _jsxFileName, lineNumber: 486}} )
          )
          , React.createElement(Field, { label: T.toll+" ($)", type: "number", value: wf.tollReimbursed, onChange: function(v){setWf(Object.assign({},wf,{tollReimbursed:v}));}, money: true, placeholder: "0.00", __self: this, __source: {fileName: _jsxFileName, lineNumber: 486}} )
          , React.createElement('div', { style: {fontSize:13,color:C.text3,marginTop:6,marginBottom:-4}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 486}}, "🚗 " , lang==="en"?"Operations":"运营")
          , React.createElement('div', { style: {display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 487}}
            , React.createElement(Field, { label: T.trips, type: "number", value: wf.trips, onChange: function(v){setWf(Object.assign({},wf,{trips:v}));}, placeholder: "0", __self: this, __source: {fileName: _jsxFileName, lineNumber: 488}} )
            , React.createElement(Field, { label: lang==="en"?"Drive (h)":"行驶时长(h)", type: "number", value: wf.hours, onChange: function(v){setWf(Object.assign({},wf,{hours:v}));}, placeholder: "0", __self: this, __source: {fileName: _jsxFileName, lineNumber: 489}} )
      ...
      , sf==="stmt" ? (
        React.createElement(Modal, { title: stf.id?T.edit+" "+T.monthly:T.monthly, onClose: function(){setSf(null);}, onSave: function(){if(!stf.grossFare)return;if(stf.id){var nsl2=sl.map(function(x){return x.id===stf.id?Object.assign({},stf):x;});setSl(nsl2);autoSave({sl:nsl2});}else{var ex=sl.find(function(x){return x.month===stf.month&&x.platform===stf.platform;});if(ex){setSl(sl.map(function(x){return x.id===ex.id?Object.assign({},stf,{id:ex.id}):x;}));}else{setSl([Object.assign({},stf,{id:Date.now()})].concat(sl));}}setSf(null);}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 497}}
          ...
          , React.createElement(Field, { label: T.platform_lbl, value: stf.platform, onChange: function(v){setStf(Object.assign({},stf,{platform:v}));}, options: allPlat.map(function(p){return [p,p];}), __self: this, __source: {fileName: _jsxFileName, lineNumber: 499}} )
          ...
          , React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 521}}
            ...
            , React.createElement('div', { style: {display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:8,marginBottom:14}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 523}}
              , [["车辆","&#128663;","#00D4FF","Vehicle"],["牌照","&#128203;","#FFD700","License"],["平台","&#128241;","#AB47BC","Platform"],["其他","&#128188;","#B0D4E8","Other"]].map(function(gb){
                ...
                return React.createElement('button', { key: gb[0], onClick: function(){setSelGrp(gb[0]);var first=Object.entries(allC).find(function(e){if(veh.type==="electric"&&e[0]==="fuel")return false;if(veh.type==="petrol"&&e[0]==="charging")return false;return e[1].g===gb[0];});if(first)setEf(Object.assign({},ef,{category:first[0]}));}, style: {padding:"8px 4px",borderRadius:10,border:"2px solid "+bdCol,background:bgCol,color:textCol,fontSize:12,fontWeight:fw,cursor:"pointer",textAlign:"center"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 527}}
                  , React.createElement('div', { style: {fontSize:18,marginBottom:2}, dangerouslySetInnerHTML: {__html:gb[1]}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 528}} ), React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 528}}, lbl)
                );
              })
            )
        ...
        React.createElement('div', { style: {position:"fixed",inset:0,zIndex:400,display:"flex"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 596}}
          , React.createElement('div', { style: {width:"60%",maxWidth:220,background:C.bg2,height:"100%",overflowY:"auto",borderRight:"1px solid "+C.border,display:"flex",flexDirection:"column",paddingBottom:"70px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 597}}
            , React.createElement('div', { style: {padding:"20px 18px 16px",borderBottom:"1px solid "+C.border}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 598}}
              ...
              , React.createElement('div', { style: {fontSize:11,color:C.text3,marginTop:2}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 600}}, "NYC RIDESHARE TRACKER · v2.1.5"    )
            )
      ...
      , showGoal ? (
        React.createElement('div', { style: {position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:300,padding:20}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 611}}
          , React.createElement('div', { style: {background:C.bg2,borderRadius:16,padding:24,width:"100%",maxWidth:320,border:"1px solid "+C.border}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 612}}
            , React.createElement('div', { style: {fontSize:16,fontWeight:800,marginBottom:16}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 613}}, "🎯 " , lang==="en"?"Monthly Income Goal":"本月收入目标")
          ...
          , React.createElement('div', { style: {maxWidth:600,margin:"0 auto",padding:"0 0 80px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 679}}
            ...
            , React.createElement('div', { style: {padding:"16px 14px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 687}}
              ...
              , React.createElement(Card, { style: {marginBottom:12,padding:"14px 14px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 689}}
                ...
                , React.createElement('div', { style: {fontSize:11,color:C.text3,marginBottom:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 689}}, taxRateNote||(lang==="en"?"Tap a year to load IRS defaults, or edit any rate manually":"点年份加载 IRS 标准税率，或手动修改任意一项"))
                // Year preset buttons
                ...
                , React.createElement('div', { style: {display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:8}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 689}}
                  , React.createElement('div', { style: {background:"#0A1828",border:"1px solid #2A3A54",borderRadius:8,padding:"8px 10px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 689}}
                    , React.createElement('div', { style: {fontSize:11,color:C.text3,marginBottom:4}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 689}}, lang==="en"?"SE Tax (固定)":"自雇税 (固定)")
                  ...
                  , React.createElement('div', { style: {background:"#0A1828",border:"1px solid #2A3A54",borderRadius:8,padding:"8px 10px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 689}}
                    , React.createElement('div', { style: {fontSize:11,color:C.text3,marginBottom:4}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 689}}, lang==="en"?"Federal":"联邦所得税")
                    , React.createElement('div', { style: {display:"flex",alignItems:"baseline",gap:3}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 689}}
                  ...
                  , React.createElement('div', { style: {background:"#0A1828",border:"1px solid #2A3A54",borderRadius:8,padding:"8px 10px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 689}}
                    , React.createElement('div', { style: {fontSize:11,color:C.text3,marginBottom:4}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 689}}, lang==="en"?"State + City":"州+市税")
                    , React.createElement('div', { style: {display:"flex",alignItems:"baseline",gap:3}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 689}}
                  ...
                  , React.createElement('div', { style: {background:"#0A1828",border:"1px solid #2A3A54",borderRadius:8,padding:"8px 10px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 689}}
                    , React.createElement('div', { style: {fontSize:11,color:C.text3,marginBottom:4}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 689}}, lang==="en"?"Std Deduction":"标准扣除")
                    , React.createElement('div', { style: {display:"flex",alignItems:"baseline",gap:3}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 689}}
              ...
              , React.createElement(Card, { style: {marginBottom:12,padding:"12px 14px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 689}}
                ...
                , React.createElement('div', { style: {fontSize:11,color:C.text3,marginBottom:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 689}}, lang==="en"?"App estimates are rough. Use these official tools for filing.":"App 估算仅供参考，报税时请用以下官方工具")
                , [
              ...
              , (function(){
                ...
                var totalAnnualTax=seTax+fedIncTax+stateIncTax;
                ...
                return React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 714}}
                  , React.createElement(Card, { style: {marginBottom:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 715}}, React.createElement('div', { style: {fontSize:14,fontWeight:800,color:"#FFD700",marginBottom:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 715}}, "📋 Schedule C"  )
                    , React.createElement(Row, { label: lang==="en"?"Gross Income":"总收入", value: fmt(grossInc), color: "#00D4FF", __self: this, __source: {fileName: _jsxFileName, lineNumber: 716}} )
        ...
        React.createElement('div', { style: {position:"fixed",inset:0,background:"rgba(2,4,12,0.95)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:400,padding:"16px"} }
          , React.createElement('div', { style: {background:C.bg2,borderRadius:16,width:"100%",maxWidth:600,border:"1px solid "+C.border,maxHeight:"92vh",display:"flex",flexDirection:"column",overflow:"hidden"} }
            , React.createElement('div', { style: {display:"flex",justifyContent:"space-between",alignItems:"center",padding:"14px 18px",borderBottom:"1px solid #1A2A44",flexShrink:0} }
              ...
              , React.createElement('div', { style: {fontSize:16,fontWeight:800} }, "📊 " , lang==="en"?"Import Annual Tax Summary":"导入年度税务总结")
            ...
            , React.createElement('div', { style: {padding:"16px 18px",overflowY:"auto",flex:1} }
              ...
              , pasteUberTaxResult ? React.createElement('div', { style: {marginTop:14} }
                  , React.createElement('div', { style: {padding:"14px 16px",background:"#1A1000",border:"1px solid #5A3A00",borderRadius:10,marginBottom:12} }
                    , React.createElement('div', { style: {fontSize:14,fontWeight:800,color:"#FFB300",marginBottom:10} }, "✓ " , lang==="en"?"Tax Year ":"税务年度 " , pasteUberTaxResult.year)
                  ...
                  , (pasteUberTaxResult.hasMonthly && pasteUberTaxResult.hasTrips) ? React.createElement('div', { style: {marginBottom:12} }
                      ...
                      , React.createElement('div', { style: {background:C.bg3,border:"1px solid "+C.border,borderRadius:8,padding:"8px 12px",fontSize:11,fontFamily:"monospace"} }
                        , (function(){
                  ...
                  , React.createElement('div', { style: {fontSize:11,color:C.text3,padding:"8px 10px",background:"#0A1828",border:"1px solid #1A2A44",borderRadius:8,marginBottom:10,lineHeight:1.6} }
                  ...
                  , (pasteUberTaxResult.hasMonthly && pasteUberTaxResult.hasTrips) ? React.createElement('button', { onClick: function(){
                        ...
                        var yr=r.year;
                        // Check if any 2024 Uber statements exist
                      ...
                      if(ex){
                        ...
                        setWl(wl.map(function(w){
                          ...
                          return Object.assign({}, w, {
                            ...
                            tollReimbursed:r.tollReimbursed, notes:r.notes
                          });
                        }));
                      }else{
                        setWl([{
          ...
          , React.createElement('div', { style: {background:C.bg2,padding:"18px",borderBottom:"1px solid "+C.border,display:"flex",justifyContent:"space-between",alignItems:"center",position:"sticky",top:0,zIndex:10}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 838}}
            ...
            , React.createElement('div', { style: {maxWidth:600,margin:"0 auto",padding:"20px 16px 60px",fontFamily:"monospace"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 842}}
              ...
              , reportData.type==="exp" ? (
                React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 849}}
                  ...
                  , ["车辆","牌照","平台","其他"].map(function(g){var cats=reportData.byGroup[g];if(!cats||!cats.length)return null;var gTotal=cats.reduce(function(s,c){return s+c.total;},0);var gcl=g==="车辆"?"#00D4FF":g==="牌照"?"#FFD700":g==="平台"?"#CC88FF":"#B0D4E8";var glbl=lang==="en"?(g==="车辆"?"Vehicle":g==="牌照"?"License":g==="平台"?"Platform":"Other"):g;return React.createElement('div', { key: g, style: {marginBottom:16}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 851}}
                    ...
                    , cats.map(function(cat){var ct=cat.items?cat.items.length:(cat.count||0);return React.createElement('div', { key: cat.label, style: {display:"flex",justifyContent:"space-between",padding:"3px 0 3px 16px"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 853}}, React.createElement('span', { style: {fontSize:13,color:C.text2}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 853}}, cat.icon, " " , cat.label, React.createElement('span', { style: {fontSize:11,color:C.text3,marginLeft:6}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 853}}, "×", ct)), React.createElement('span', { style: {fontSize:13,color:C.text}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 853}}, fmt(cat.total)));})
                ...
                React.createElement('div', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 862}}
                  ...
                  , React.createElement('div', { style: {display:"flex",justifyContent:"space-between",padding:"10px 0",borderTop:"1px solid #2A4060",marginBottom:20}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 872}}
                    , React.createElement('span', { style: {fontSize:13,fontWeight:700,color:C.text2,letterSpacing:1}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 873}}, lang==="en"?"Total Income":"总收入")
              ...
              , React.createElement('div', { style: {borderTop:"2px solid #2A4060",marginTop:20,padding:"14px 0",textAlign:"center"}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 898}}
                , React.createElement('div', { style: {fontSize:11,color:"#6A8AAA",letterSpacing:1}, __self: this, __source: {fileName: _jsxFileName, lineNumber: 899}}, "NYC DRIVER TRACKER"  )
              )
            )
          )
      ) : null
